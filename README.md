...
Этот репозиторий реализует прототип AI‑агента поддержки с RAG‑поиском, слоем инструментов (Tools / Контекстных сценариев) и простым web‑UI для тестирования всех методов.
